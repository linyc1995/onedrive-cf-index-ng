...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 z-[100] border-b border-gray-100 bg-white dark:border-gray-700 dark:bg-gray-900">
      <Toaster />
      ...
      <div className="mx-auto flex w-full items-center justify-between space-x-4 px-4 py-1">
        ...
        <div className="flex flex-1 items-center space-x-4 text-gray-700 md:flex-initial">
          <button
            className="flex flex-1 items-center justify-between rounded-md bg-gray-50 px-2.5 py-1.5 hover:bg-gray-100 dark:bg-gray-800 dark:text-white md:w-48"
            onClick={openSearchBox}
          >
            <div className="flex items-center space-x-2">
              <FontAwesomeIcon className="h-4 w-4" icon="search" />
              <span className="truncate text-sm font-medium">搜索文件...</span>
            </div>
            <div className="hidden items-center space-x-1 md:flex">
              <div className="rounded bg-gray-200 px-2 py-1 text-xs font-medium dark:bg-gray-700">
                {os === 'mac' ? '⌘' : 'Ctrl'}
              </div>
              <div className="rounded bg-gray-200 px-2 py-1 text-xs font-medium dark:bg-gray-700">K</div>
            </div>
          </button>
      ...
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="fixed inset-0 z-10 overflow-y-auto" open={isOpen} onClose={() => setIsOpen(false)}>
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="my-8 inline-block w-full max-w-md transform overflow-hidden rounded-lg border border-gray-100 bg-white p-6 text-left align-middle transition-all dark:border-gray-700 dark:bg-gray-900">
                ...
                <div className="mt-8 flex items-center justify-end">
                  <button
                    className="mr-3 inline-flex items-center justify-center space-x-2 rounded border border-gray-200 px-4 py-2 text-gray-700 hover:bg-gray-50 focus:outline-none dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-800"
                    onClick={() => setIsOpen(false)}
                  >
                    取消
                  </button>
                  <button
                    className="inline-flex items-center justify-center space-x-2 rounded bg-gray-700 px-4 py-2 text-white hover:bg-gray-800 focus:outline-none dark:bg-gray-600 dark:hover:bg-gray-500"
                    onClick={() => clearTokens()}
                  >
